  ...
  constructor(
    ...
    const rawProjects: Project[] = [
      ...
      },
      {
        ...
        description: 'Inspired by my favorite calculator, Desmos, I wrote a plugin-based calculator that allows the user to solve problems both symbolically and numerically. The calculator is split up into three main parts: the plugin manager, the Python executor, and the project. Plugins are written in Python and executed with a WASM-compiled Cython interpreter so Python\'s powerful symbolic solving libraries can be utilized. I aim to make writing a plugin as simple as possible so people with expert math skills and minimal programming skills can contribute. <a href="https://github.com/icanthink42/alpha_solve/blob/main/docs/plugin-development.md" target="_blank">Plugin creation docs</a>',
        htmlTags: [
      ...
      },
      {
        ...
        description: 'I talk with a lot of engineers who program often in MATLAB and Python, but rarely venture into the land of languages like C or C++. To this crowd, pointers are a scary concept because they are seen as a low-level concept that only exists in \'real\' programming languages. The reality of programming is that pointers always exist, and no matter how hard a language tries to hide them, you need to understand them to program. I wrote this program to attempt to demonstrate what a pointer is in a familiar context. I facetiously put \'Even Bad Languages Have Pointers\' in the title.',
        htmlTags: [
      ...
      },
      {
        ...
        description: 'I have been a huge fan of the calculator Desmos for a long time. I originally started using it in high school for homework, but since then I\'ve had a lot of fun playing around with all the quasi-programming features they\'ve added over the years. Back when I had a lot more free time I wrote this flight simulator using those features. I also wrote an <a href="https://www.desmos.com/calculator/t5pj25dz7g" target="_blank" rel="noopener">n-body simulator in Desmos</a>.',
        htmlTags: [
      ...
      },
      {
        ...
        description: 'I came up with the idea for this small simulation when talking with my dad about the nature of entropy. I was arguing that entropy is not a physical law but rather a statistical law. I wrote this simulation to demonstrate this idea. The simulation I wrote has very simple laws: particles bounce off walls and each other, and particles move at constant velocity. When you click inside the simulation, you can add particles to the system. This decreases the specific entropy as the new particles have fewer degrees of freedom. Over time the system naturally moves to a state of maximum entropy. The point I was trying to make about entropy is that it is a result of simple natural laws that maximize the number of possible configurations of a system. Entropy is not a physical law, it is a statistical law.',
        htmlTags: [
